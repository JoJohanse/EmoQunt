...
# 情绪快照解析契约（B5 架构评审）收进 src/data/sentiment_snapshots.py（SnapshotStore
# 唯一实现）；此处 re-export 保持旧 import 路径兼容：
# `from src.data.data_manager import load_sentiment_snapshots, build_stock_sentiment_series`
from src.data.sentiment_snapshots import (  # noqa: F401
    build_stock_sentiment_series, load_sentiment_snapshots,
)
